...
public class Mythingsdemo {
	...
	public static void create_Project_Construction() throws InterruptedException {
		...
		Thread.sleep(4000);
		WebElement Construction = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LiearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View/android.view.View[1]"));
		Construction.click();
		Thread.sleep(4000);
...
//          driver.pressKey(keyEvent1);
	   ...
	   public static void create_Item_Properties() throws InterruptedException {
		    ...
		    scroll_view.get(0).click();		    
		    Thread.sleep(5500);
			WebElement Add_Item1 = driver.findElement(By.xpath("(//android.view.View[@contet-desc=\"Add Item\"])[2]"));
			Add_Item1.click();
			Thread.sleep(5000);
			WebElement Done = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Done\"]"));
			Done.click();
...
//			driver.findElement(By.xpath(""))
		...
		public static void ADDPEOPLE_Create_People_Profile_FRIENDS() throws InterruptedException {
			...
			Add_People_1.click();
			Thread.sleep(2000);
			WebElement AddMyPeopleProfile = driver.findElement(By.xpath("/hierarchy/android.widget.FameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View/android.view.View[2]"));
			AddMyPeopleProfile.click();
			Thread.sleep(2000);
...
//			select_the_tag.click();
			...
			Thread.sleep(3000);
			 ...
			 WebElement confirm = driver.findElement(By.xpath("//android.widget.Buton[@content-desc=\"Confirm\"]"));
			 confirm.click();
			Thread.sleep(3500);
			driver.navigate().back();
		...
		public static void Upload_Through_Item() throws InterruptedException {
			...
			Thread.sleep(4000);
			List<WebElement> Folder_Name = driver.findElements(By.className("andrid.widget.EditText"));
...
//			select_the_tag.click();
			Thread.sleep(4000);
			WebElement upload2 = driver.findElement(By.xpath("//android.widget.Buttn[@content-desc=\"Upload\"]"));
			upload2.click();
			Thread.sleep(4000);
			WebElement done = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Done\"]"));
			done.click();
...
//			check.get(6).click();
		...
		//Thread.sleep(4000);
		//WebElement select_the_tag = driver.findElement(By.xpath("//android.viewView[@content-desc=\"#ererr\"]"));
		//select_the_tag.click();
		Thread.sleep(4000);
		WebElement upload2 = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Upload\"]"));
		upload2.click();
...
//			
		...
		//select_the_tag.click();
		Thread.sleep(4000);
		WebElement upload2 = driver.findElement(By.xpath("//android.widget.Button[@ontent-desc=\"Upload\"]"));
		upload2.click();
		Thread.sleep(4000);
		WebElement done = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Done\"]"));
		done.click();
...
//			select3.click();
		...
		public static void Using_Trash_RestoreAll() throws InterruptedException {
			...
			Trash.click();
			Thread.sleep(3000);
			WebElement list = driver.findElement(By.xpath("/hierarchy/android.wdget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.ImageView[2]"));
			list.click();
			Thread.sleep(3000);
		...
		public static void Things_Archive() throws InterruptedException {
			...
			Thread.sleep(4000);
			List<WebElement> imageview1 = driver.findElements(By.className("androi.widget.ImageView"));
			int size3 = imageview1.size();
			Thread.sleep(3500);
			System.out.println("tell" +size3);
			Thread.sleep(5000);
...
//			Profile.click();
		...
		public static void people_Archive() throws InterruptedException {
			...
			Thread.sleep(9000);
			List <WebElement>profile = driver.findElements(By.className("android.wdget.ImageView"));
			System.out.println(profile.size());
			Thread.sleep(6000);
			profile.get(2).click();
//			WebElement Profile = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.ImageView[3]"));
...
//			Profile.click();
		...
		public static void R_B_Archive_Inbox() throws InterruptedException {
			...
			profile.get(2).click();
			Thread.sleep(4000);
			WebElement Archive1 = driver.findElement(By.xpath("//android.widget.ImaeView[@content-desc=\"Archive\"]"));
			Archive1.click();
			Thread.sleep(4000);
